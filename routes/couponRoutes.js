...
router.get('/promotions', getActivePromotions); // Get active promotions ( no need to be authenticated)
router.post('/apply', authMiddleware, applyCoupon); // Apply a coupon (for users)
